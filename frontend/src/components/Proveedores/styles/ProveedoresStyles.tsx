export function ProveedoresStyles() {
  return (
    <style dangerouslySetInnerHTML={{ __html: `
      ...
      .dark .proveedores-root [data-slot="card-title"],
      ...
      .dark .proveedores-root tr {
        border-bottom: 1px solid rgba(255, 255, 255, 0.05) !important;
        transition: background 0.2s ease;
      }

      .dark .proveedores-root tr:hover {
        background: rgba(99, 102, 241, 0.05) !important;
      }

      .dark .proveedores-root td {
      ...
      .proveedores-btn-primary:hover {
        background: linear-gradient(135deg, #1d4ed8, #4338ca);
        box-shadow: 0 6px 14px rgba(37, 99, 235, 0.3);
        transform: translateY(-1px);
      }

      .dark .proveedores-btn-primary {
      ...
      .dark .proveedores-btn-primary:hover {
        box-shadow: 0 6px 15px rgba(99, 102, 241, 0.2) !important;
        transform: translateY(-1px);
      }

      /* Entrance Animation */
      .proveedores-content-animate {
        animation: proveedores-fade-in 0.5s cubic-bezier(0.4, 0, 0.2, 1) forwards;
      }

      @keyframes proveedores-fade-in {
        from {
          opacity: 0;

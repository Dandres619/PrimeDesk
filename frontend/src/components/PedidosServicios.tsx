...
export function PedidosServicios() {
  ...
  const totalPages = Math.max(1, Math.ceil(filteredServiceOrders.length / itemsPerPage));
  const paginatedServiceOrders = filteredServiceOrders.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage);

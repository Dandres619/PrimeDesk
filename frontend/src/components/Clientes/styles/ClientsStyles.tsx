export function ClientsStyles() {
    return (
        <style>{`
            ...
            .dark .clients-root [data-slot="card"] {
            ...
            .dark .clients-root [data-slot="card-title"],
            ...
            /* Table Rows */
            .dark .clients-root tr {
                border-bottom: 1px solid rgba(255, 255, 255, 0.05) !important;
                transition: background 0.2s ease;
            }

            .dark .clients-root tr:hover {
                background: rgba(99, 102, 241, 0.05) !important;
            }

            .dark .clients-root td {
            ...
            .dark .cli-btn-primary:hover {
                box-shadow: 0 6px 15px rgba(99, 102, 241, 0.2) !important;
                transform: translateY(-1px);
            }

            /* Entrance Animation */
            .clients-content-animate {
                animation: clients-fade-in 0.5s cubic-bezier(0.4, 0, 0.2, 1) forwards;
            }

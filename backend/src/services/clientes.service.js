...
const remove = async (id) => {
  ...
  const agendamientos = await sql`SELECT COUNT(*) FROM agendamientos a INNER JOIN reparaciones r ON r.id_agendamiento = a.id_agendamiento INNER JOIN motocicletas m ON r.id_motocicleta = m.id_motocicleta WHERE m.id_cliente = ${id}`;

...
export function Servicios() {
  ...
  const [services, setServices] = useState([
    {
      ...
      description: 'Revisión general de la motocicleta, cambio de filtros y fluidos',
      status: 'Activo',
    ...
    },
    {
      ...
      description: 'Cambio de pastillas, discos y revisión del sistema de frenos',
      status: 'Activo',
    ...
    {
      id: 4,
      name: 'Cambio de Transmisión',
      description: 'Reemplazo completo del sistema de transmisión',
      status: 'Activo',
    ...
    },
    {
      ...
      description: 'Evaluación completa del estado de la motocicleta',
      status: 'Activo',
    ...
    },
    {
      ...
      description: 'Modificaciones estéticas y de rendimiento',
      status: 'Activo',
    ...
    },
    {
      id: 8,
      name: 'Afinación',
      description: 'Ajuste de carburador, bujías y sistema de encendido',
      status: 'Inactivo',
  ...
  const showDeleteConfirm = (serviceId: number) => {
    setConfirmDialog({
      open: true,
      title: 'Eliminar Servicio',
      description: '¿Está seguro de que desea eliminar este servicio? Esta acción no se puede deshacer.',
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          <CardContent className="flex items-center p-6">
            ...
            <div>
              <p className="text-2xl font-bold">{services.filter(s => s.status === 'Activo').length}</p>
        ...
        <Card>
          <CardContent className="flex items-center p-6">
            ...
            <div>
              <p className="text-2xl font-bold">{services.filter(s => s.status === 'Inactivo').length}</p>
